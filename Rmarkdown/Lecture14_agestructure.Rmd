...
ps1 = cbind.data.frame(p12=runif(min=0.4, max=0.92, n=nsample), 
                       p23 = runif(min=0.3, max=0.72, n=nsample),
                       p34 = runif(min=0.05, max=0.22, n=nsample))

ps2 = cbind.data.frame(p12=runif(min=0.4, max=0.92, n=nsample), 
                       p23 = runif(min=0.3, max=0.72, n=nsample),
                       p34 = runif(min=0.05, max=0.22, n=nsample))
...
res = as.data.frame(sens_micro$X) %>% 
  pmap_dbl(p_wrapper, initialpop=ini, nstep=nmonths, use_func=evolve_pop)
