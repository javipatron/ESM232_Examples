...
setwd("~/Documents/MEDS/Courses/eds230/classes/ESM232_Examples/Rmarkdown")
...
# lets make the threshold 90% of carrying capacity. This function will wun the ODE for each parameter
...
allresults = as.data.frame(sens_P$X) %>% 
  pmap(p_wrapper, Pinitial=Pinitial, simtimes=simtimes, func=dpopgrowth)
...
# Take a look at how much each threshold is changing. See how much they are affective.
